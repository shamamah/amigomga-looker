view: eop_claimcounts_triangle_treaty_policy_quarter {
  derived_table: {
    sql:  SELECT DATEDIFF(m, t.eff_date, ProcessingDate) / 3 as treaty_quarter,
 ...
 -- WHERE z.loss_date > z.eff_date
  ...
  dimension: unique_key  {
    ...
    hidden: yes
    primary_key: yes
    sql: CONCAT(${policy_quarter},'_',${trans_quarter},'_',${lag_quarter},'_',${treaty_quarter},'_',${coveragecode_id},'_',${new_ren},'_',${lob_id}) ;;
  }
