view: eop_claimcounts_triangle_policy_quarter {
  derived_table: {
    sql:  Select
                  CASE WHEN DATEDIFF(q, '2019-05-01', z.eff_date) < 0 THEN 0 ELSE DATEDIFF(q, '2019-05-01', z.eff_date) END as policy_quarter,
                  CASE WHEN DATEDIFF(q, z.eff_date, ProcessingDate) < 0 THEN 0 ELSE DATEDIFF(q, z.eff_date, ProcessingDate) END
      ...
      LEFT OUTER JOIN dbo.ClaimFeatureActivity od
       ...
       -- WHERE z.loss_date > z.eff_date
          ...
          DATEDIFF(q, z.eff_date, ProcessingDate),
          --CASE WHEN DATEDIFF(m, '2019-05-01', z.eff_date) < 0 THEN 0 ELSE DATEDIFF(m, '2019-05-01', z.eff_date) END,
  ...
  dimension: unique_key  {
    ...
    hidden: yes
    primary_key: yes
    sql: CONCAT(${TABLE}.policy_quarter,'_',${TABLE}.trans_quarter,'_',${TABLE}.lag_quarter,'_',${coveragecode_id},'_',${new_ren},'_',${lob_id}) ;;
  }
